...
export default function VenezuelaMap({
  ...
  const clubOf = (city: string) =>
    CLUBS.filter(c => c.state === city)
      .map(c => c.name)
      .join(' · ')
  ...
  useEffect(() => {
    ...
    const loadMap = async () => {
      try {
        ...
        // Pings
        Object.entries(STATE_CENTERS).forEach(
          ([stateName, latlng]) => {
    ...
    <section className="max-w-5xl mx-auto px-6 py-24">
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            'inset 0 1px 0 rgba(255,255,255,0.12),0 8px 40px rgba(0,0,0,0.45)',
        }}
      >
          ...
          {tooltip && (
            ...
            <motion.div
              ...
              style={{
                ...
                background:
                  'linear-gradient(135deg,rgba(249,115,22,0.22),rgba(212,160,23,0.14))',
                ...
                boxShadow:
                  '0 4px 24px rgba(249,115,22,0.2),inset 0 1px 0 rgba(255,255,255,0.15)',
            ...
            >
              ...
              <p className="text-xs text-white/65 mt-0.5">
                {tooltip.clubs || 'Club por confirmar'}
              </p>

              <p className="text-xs text-white/50">
                {tooltip.count} inscritos
              </p>
        ...
        <div className="
          ...
          <div className="flex items-center gap-2">
            ...
            <div
              ...
              style={{
                background:
                'repeating-linear-gradient(45deg,rgba(212,160,23,0.5) 0px,rgba(212,160,23,0.5) 2px,transparent 2px,transparent 5px)',
